...
public class ShopPage extends BasePage {
    ...
    /**
     * Step 1: Buy a specified quantity of a given product.
     * Used for adding products like Stuffed Frog, Fluffy Bunny, and Valentine Bear.
     *
    ...
    /**
     * Utility: Waits for the 'Checkout' button to be clickable.
     ...
     * Clicks on the 'Cart' link after ensuring the page is ready.
     */
    ...
    /**
     * Step 4: Verifies the price format of a product in the cart.
     * Ensures price follows the format like $10.99.
     *
    ...
    /**
     * Step 3: Verifies that the subtotal for a product is correct.
     * Calculates expected subtotal as unit price × quantity and compares with displayed value.
     *
    ...
    /**
     * Optional Utility: Verifies that the cart's total matches the sum of all product subtotals.
     * This helps ensure no miscalculations across the cart.
     *
